...
Login URL: https://simulator-75lk3meynq-el.a.run.app/candidate/login

Email: vaibhavsethia110@gmail.com

Base URL: https://simulator-75lk3meynq-el.a.run.app
...
## `GET /v1/session/{session_id}/transcript` _(dev only)_
