...
In this repository (read its README first):
...
You should pick Python, FastAPI, Langgraph + Langchain based stack — we will not run your code, you submit your own hosted service + source code.

---

## Policy hints (intentionally minimal)

These hints are the _floor_, not the _ceiling_. Use judgement.
...
We are _not_ giving you exact thresholds or a refund matrix on purpose. Part
...
5. Your prod score sheet from `GET /v1/candidate/summary`.
